...
public OnPluginStart()
{
    ...
    g_hWeaponRandomAmount   = CreateConVar( "l4d2_MITSR_Amount",        "0", "Number of weapons to spawn if l4d2_MITSR_Random is 1"); 
    ...
    g_hWeaponFireAxe            = CreateConVar( "l4d2_MITSR_FireAxe",       "0", "Number of fireaxes to spawn (l4d2_MITSR_Random must be 0)");
